...
INSERT INTO supply_company(comp_code, comp_name, comp_addr, comp_tel, comp_isExist) VALUES
   ...
   ("SC002", "인디넷",       "경기도 수원시 제포동",            "032-579-4512",TRUE),
   ("SC003", "참빛소프트",   "경기도 파주군 은빛아파트",        "032-501-4503",TRUE),
   ("SC004", "소프트마켓",   "서울특별시 관진구 자양동",        "02-802-4564", TRUE),
   ("SC005", "크라이스",     "경기도 고양시 대자동 서영아파트", "032-659-3215",TRUE),
...
INSERT INTO software(sw_code,group_code,sw_name,sale_price,sw_inven,sw_issale,sw_img) VALUES
   ...
   ("SW002","OF", "국제무역",    48000,   500,   TRUE,"dgit"),
   ("SW003","GM", "FIFA2015",   40500,     1000 , TRUE,"dgit"),
   ("SW004","GM", "삼국지",   48000,     400,   TRUE,"dgit"),
   ("SW005","GM", "아마겟돈",   50750,     1000,  TRUE,"dgit"),
   ("SW006","OF", "한컴오피스",1918000, 2000,  TRUE,"dgit"),
   ("SW007","GR", "포토샵",   1519000, 400,   TRUE,"dgit"),
   ("SW008","ED", "오토캐드",   978000,    2,       TRUE,"dgit"),
   ("SW009","GM", "인디자인",    218040,    4000,  TRUE,"dgit"),
...
INSERT INTO delivery(del_code, comp_code, sw_code, supply_price, supply_amount, order_date, del_isExist) VALUES
   ...
   ("DL004", "SC004", "SW004", 17000, 150, now(), TRUE),
   ...
   ("DL010", "SC004", "SW010", 25000, 200, now(), TRUE),
