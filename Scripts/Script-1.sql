...
select empno,empname,adress,emppnumber from emp where empno=2;
INSERT INTO emp VALUES(1, '알럽소프트', '대구광역시 달서구', '02-930-4551');
INSERT INTO emp VALUES(2, '구린소프트', '대구광역시 달서구', '02-930-4551');
