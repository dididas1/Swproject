package kr.or.dgit.sw_project.initsettingservice;
...
public class Config {
	...
	public static final String[] TABLE_NAME = {"members","client","category","software","supply_company","delivery","sale","address"};
	...
	public static final String[] CREATE_VIEW={
			...
			+ "SELECT s.order_date,s.sale_code,cl.clnt_name,sw.sw_name,s.sale_amount,s.isdeposit,sd.total_sale_price ,sw.sale_price "
